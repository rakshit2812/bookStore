            ...
            <div className="lg:col-span-1">
              <div className={`rounded-xl shadow-lg p-6 sticky top-24 ${theme === "dark" ? "bg-slate-900" : "bg-white"}`}>
                ...
                <button
                  ...
                  className="w-full mt-6 px-6 py-4 bg-gradient-to-r from-pink-500 to-purple-600 text-white text-lg font-semibold rounded-lg hover:from-pink-600 hover:to-purple-700 transform hover:scale-[1.02] transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                >
                  {processing && (
                    <svg
                  ...
                  <span>{processing ? "Processing Order..." : "Place Order"}</span>
                </button>
